...
| 2026-09-22 | Device-testing prep | `docs/TESTING.md` (console setup checklist for Hree + device QA checklist + phase-1 gates); `infra/deploy.sh` (build+test+deploy rules/indexes/functions to a project ID); `infra/.firebaserc.example` + `infra/.gitignore` (local-only project aliases) |
